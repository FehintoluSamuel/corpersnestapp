...
export default function PublicProfilePage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([userData, allListings]) => {
        setProfile(userData)
        setListings(allListings.filter(l => l.owner_id === userData.id && l.status === 'active'))
      })
      .catch(() => setError(true))
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="card p-5 mb-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="font-semibold text-lg leading-tight mb-1.5"
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 gap-3 p-3 rounded-xl mb-4"
            ...
            <div className="text-center">
              ...
              <div className="text-xs mt-0.5" style={{ color: 'var(--text-muted)' }}>Member since</div>
            </div>
          </div>

          {/* Contact — logged-in users only */}
          {canContact ? (
            <div className="flex flex-col gap-2">
              <a
                href={`tel:${profile.phone_no}`}
